...
run_megahit () {
  ...
  megahit --12 $inpf1 --k-max 145 --k-min 15 --k-step 6 --verbose -o $vicinity/${lbl}_Megahit_assemblies --memory 0.99 --num-cpu-threads 6
  printf "\n Ran megahit and assembled the metagenome from input file $inpf1\n"
  mail -s "Progress Monitoring 85763000" $uie <<< "Ran megahit and assembled the metagenome from input file $inpf1"
}

run_megahit $INPF1 $UIE $label $locale
