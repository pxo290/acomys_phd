...
#mkdir "${LABEL}Progressive_Cactus_jobstore"
...
cactus --batchSystem Slurm --binariesMode local --maxCores 12 --maxMemory 256G --workDir "$WORKDIR" --defaultDisk 5G "$JOBSTORE" /ei/projects/c/c33dfa31-8d66-4727-827b-ce9eb62d3237/scratch/2021_07_06-Cactus_list_file.txt "${LABEL}cactus_run_culture_SPADES_assemblies_nearest_relatives_MIGA_and_representatives.hal"
