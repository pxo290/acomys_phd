...
#SBATCH -c 4
#SBATCH -J 2022-05-29_RS_trial_script_part_5_DFAST_on_MaxBin2_bins
#SBATCH --mem=725gb
#SBATCH --mail-type=begin,end,fail
#SBATCH --mail-user=peter.osborne@earlham.ac.uk
#SBATCH -o /ei/projects/c/c33dfa31-8d66-4727-827b-ce9eb62d3237/scratch/2022-04-05_Extra_or_side_stuff/RS_experimenting/slurm_outputs/2022-05-29_RS_trial_script_part_5_DFAST_on_MaxBin2_bins-%A.out
#SBATCH -e /ei/projects/c/c33dfa31-8d66-4727-827b-ce9eb62d3237/scratch/2022-04-05_Extra_or_side_stuff/RS_experimenting/slurm_outputs/2022-05-29_RS_trial_script_part_5_DFAST_on_MaxBin2_bins-%A.err
...
#Part 5 of the script will run DFAST on the
