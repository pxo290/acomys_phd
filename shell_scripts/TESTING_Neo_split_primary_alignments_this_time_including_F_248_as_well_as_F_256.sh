...
split_out_alignments () {
  ...
  then
    output_label=$(echo "${output_lobel}_NEO_exclude_flags_2304_alignments_only")
    samtools view -F 2304 -h "$inpf1" > "${output_label}.bam"
