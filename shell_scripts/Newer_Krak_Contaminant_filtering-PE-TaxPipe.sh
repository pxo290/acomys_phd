...
printf "\nRunning Kraken2 with different confidence scores using new database \n"
kraken2_run $RFQ1 $RFQ2 1.00 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
kraken2_run $RFQ1 $RFQ2 0.95 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
kraken2_run $RFQ1 $RFQ2 0.75 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
kraken2_run $RFQ1 $RFQ2 0.50 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
kraken2_run $RFQ1 $RFQ2 0.25 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
kraken2_run $RFQ1 $RFQ2 0.10 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
kraken2_run $RFQ1 $RFQ2 0.05 $MDN /ei/public/databases/kraken/2.0.7_refseq-201910 NEWDB
