...
#SBATCH -p ei-medium
#SBATCH -c 2
#SBATCH -J 2023-01-25_RS_binning_based_individual_assemblies_script.sh
#SBATCH --mem=256gb
#SBATCH --mail-type=begin,end,fail
#SBATCH --mail-user=peter.osborne@earlham.ac.uk
#SBATCH -o /ei/projects/5/5306b670-79f8-438b-aa06-d6133e2c53a4/2022-04-05_Extra_or_side_stuff/RS_experimenting/slurm_outputs/2023-01-25_RS_binning_based_individual_assemblies_script-%A.out
#SBATCH -e /ei/projects/5/5306b670-79f8-438b-aa06-d6133e2c53a4/2022-04-05_Extra_or_side_stuff/RS_experimenting/slurm_outputs/2023-01-25_RS_binning_based_individual_assemblies_script-%A.err
...
#Script can be found here on the HPC: /ei/projects/5/5306b670-79f8-438b-aa06-d6133e2c53a4/2022-04-05_Extra_or_side_stuff/RS_experimenting/scripts/2023-01-25_RS_binning_based_individual_assemblies_script.sh
