...
#SBATCH -p ei-medium
#SBATCH -c 2
#SBATCH -J 2023-01-17_revised_RS_just_binning_trial_script.sh
#SBATCH --mem=256gb
#SBATCH --mail-type=begin,end,fail
#SBATCH --mail-user=peter.osborne@earlham.ac.uk
#SBATCH -o /ei/projects/5/5306b670-79f8-438b-aa06-d6133e2c53a4/2022-04-05_Extra_or_side_stuff/RS_experimenting/slurm_outputs/2023-01-17_revised_RS_just_binning_trial_script.sh-%A.out
#SBATCH -e /ei/projects/5/5306b670-79f8-438b-aa06-d6133e2c53a4/2022-04-05_Extra_or_side_stuff/RS_experimenting/slurm_outputs/2023-01-17_revised_RS_just_binning_trial_script.sh-%A.err
...
#Script can be found here on the HPC: /ei/projects/5/5306b670-79f8-438b-aa06-d6133e2c53a4/2022-04-05_Extra_or_side_stuff/RS_experimenting/scripts/2023-01-17_revised_RS_just_binning_trial_script.sh
...
gunzip -c "$raw_inpf1" > "${top_outdir}/${run_ID}-${sampleID}.R1.fastq"
gunzip -c "$raw_inpf2" > "${top_outdir}/${run_ID}-${sampleID}.R2.fastq"
cd "$top_outdir"
inpf1="${top_outdir}/${run_ID}-${sampleID}.R1.fastq"
inpf2="${top_outdir}/${run_ID}-${sampleID}.R2.fastq"

#Next writing the QC function
execute_QC () {
    input_1="$1"
    input_2="$2"
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/QC_and_cleansed_files"
    export QC_outdir="${top_outdir}/${run_ID}-${sampleID}/QC_and_cleansed_files"
...
execute_bbduk () {
    ...
    input_2="$2"
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/QC_and_cleansed_files"
    export BBDUK_outdir="${top_outdir}/${run_ID}-${sampleID}/QC_and_cleansed_files"
...
execute_SPAdes () {
    input_1="$1"
    input_2="$2"
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Assembly_output"
    export assembly_outdir="${top_outdir}/${run_ID}-${sampleID}/Assembly_output"
...
execute_metabat2_after_mapping () {
    ...
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Binning_output"
    export binning_outdir="${top_outdir}/${run_ID}-${sampleID}/Binning_output"
    cd "$binning_outdir"
...
execute_checkm_bins () {
    ...
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_CheckM_output"
    export checkm_outdir="${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_CheckM_output"
    ...
    checkm lineage_wf -t 2 -x fa "$checkm_outdir" "$checkm_outdir"
    #Next steps
...
execute_prokka_bins_annotation () {
    input_bin="$1"
    bin_name=$(basename "$input_bin")
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_Prokka_output"
    export prokka_outdir="${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_Prokka_output"
...
execute_mapping_reads_to_bin () {
    ...
    inpf_2="$3"
    bin_name=$(basename "$input_bin")
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_Minimap_and_Salmon_output"
    export mapping_outdir="${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_Minimap_and_Salmon_output"
    #Running Minimap2
    ...
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_Minimap_and_Salmon_output/Salmon_output"
    export salmon_outdir="${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_Minimap_and_Salmon_output/Salmon_output"
...
execute_KAT_bin_analysis () {
    ...
    bin_name=$(basename "$input_bin")
    mkdir -m 755 -p "${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_KAT_output"
    export kat_outdir="${top_outdir}/${run_ID}-${sampleID}/Binning_output/${bin_name}_KAT_output"
