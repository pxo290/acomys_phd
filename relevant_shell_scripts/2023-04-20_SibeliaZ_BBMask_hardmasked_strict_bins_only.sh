...
#SBATCH -J 2023-04-20_SibeliaZ_BBMask_hardmasked_strict_bins_only
#SBATCH -c 1
#SBATCH --mem=1000gb
#SBATCH --mail-type=begin,end,fail
#SBATCH --mail-user=peter.osborne@earlham.ac.uk
#SBATCH -o /ei/projects/b/b881ad24-2c3c-4508-a6b2-b1c552453c24/slurm_outputs/2023-04-20_SibeliaZ_BBMask_hardmasked_strict_bins_only-%A.out
#SBATCH -e /ei/projects/b/b881ad24-2c3c-4508-a6b2-b1c552453c24/slurm_outputs/2023-04-20_SibeliaZ_BBMask_hardmasked_strict_bins_only-%A.err
...
#This script can be found on the hpc at: /hpc-home/osbourne/Post-EI_scripts/2023-04-20_SibeliaZ_BBMask_hardmasked_strict_bins_only.sh

#Tweaked failure catch function
failure_catch() {
  local lineno=$1
  local msg=$2
  printf "Job was a run of script:\t/hpc-home/osbourne/Post-EI_scripts/2023-04-20_SibeliaZ_BBMask_hardmasked_strict_bins_only.sh\nIt started around:\t${script_start_time}\n"
...
export output_dir="${isolates_dir}/SibeliaZ_output_bins_only"
...
cat *.bins_only.fa > "SibeliaZ.all_hardmasked_bins.Multifasta_for_alignment.fa"
...
export inpf="${output_dir}/SibeliaZ.all_hardmasked_bins.Multifasta_for_alignment.fa"
...
#   -f 256 -- memory allocation for the Bloom filter used by the graph constructor, setting it here to 256gb
